...
public class TestController {
	...
	@RequestMapping(value = "/rest/{id}/{name}" , method = RequestMethod.GET , produces="application/json")
	public @ResponseBody Employee load_Rest_EX1(@PathVariable("id") int id,@PathVariable("name") String name) {
