...
//ws://chattest-quickcabs.rhcloud.com:8000/chat?name=www
var socket_url = window.location.hostname;
//var socket_url = '<% out.println(InetAddress.getLocalHost());%>';
var port = 8000;
...
function openSocket() {
    ...
    webSocket.onclose = function(event) {
        alert('Error! Connection is closed. Try connecting again.' + event.data);
    };
}
